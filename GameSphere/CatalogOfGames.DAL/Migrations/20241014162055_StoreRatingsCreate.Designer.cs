...
namespace CatalogOfGames.DAL.Migrations
{
    ...
    [Migration("20241014162055_StoreRatingsCreate")]
    partial class StoreRatingsCreate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatalogOfGames.DAL.Entities.GameRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GameRatings", "gamecatalog");
                });

            modelBuilder.Entity("CatalogOfGames.DAL.Entities.GameStore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("GamesStores", "gamecatalog");
                });
            ...
            modelBuilder.Entity("CatalogOfGames.DAL.Entities.Store", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("IconDirectory")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CatalogOfGames.DAL.Entities.GameStore", b =>
                {
                    ...
                    b.HasOne("CatalogOfGames.DAL.Entities.Store", "Store")
                        .WithMany("GameStores")
